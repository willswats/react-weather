...
export * from './components/WeatherDaily';
export * from './components/Weather';

export * from './utils/api';
export * from './utils/askForLatLon';
export * from './utils/capitaliseFirstLetters';
export * from './utils/getDay';
export * from './utils/getTime';
